...
Initial assignment is inert at the inherited $\lambda=\LambdaReference{}$ and, on a
...
\begin{figure}[tbp]
\centering
\includegraphics[width=3.31in]{fig3_seed_spread.pdf}
\caption{\CapSpread}
\label{fig:spread}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=3.31in]{fig4_miss_distance.pdf}
\caption{\CapMiss}
\label{fig:miss}
\end{figure}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=3.31in]{fig6_replicate_gap.pdf}
\caption{\CapRepeats}
\label{fig:repeats}
\end{figure}
...
and frozen sources) bounds that inertness. The $\lambda=\LambdaReference{}$ row reproduces
...
\begin{figure}[tbp]
\centering
\includegraphics[width=3.31in]{fig14_integral_gain.pdf}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=3.31in]{fig16_lambda_sweep.pdf}
