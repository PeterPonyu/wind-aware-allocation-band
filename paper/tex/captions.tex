...
Pre-declared sweep of the assignment penalty weight $\lambda$ over
$\{\LambdaGrid{}\}$~m/N under the stock controller at the
...
the Euclidean assignment; triangles count episodes in which any call,
