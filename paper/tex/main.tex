...
\hypersetup{
  pdftitle={From directional sensing to task completion: mapping the operating envelope of wind-aware quadrotor allocation and control},
  pdfauthor={\PDFAUTHOR},
  pdfsubject={Wind-aware quadrotor allocation and control operating envelope},
  pdfkeywords={multi-robot task allocation, quadrotor swarm, wind-aware control, operating envelope, computational validation, reproducibility}
}
